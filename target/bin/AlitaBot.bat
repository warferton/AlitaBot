...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="AlitaBot" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" com.alexkirillov.alitabot.Main %CMD_LINE_ARGS%
